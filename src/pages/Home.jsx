...
function Home() {
  ...
  return (
    <main>
      {/* HERO */}
      <section className="relative bg-gray-900 text-white min-h-[90vh] flex items-center px-4 md:px-16 py-20"
        style={{
        ...
        <div className="max-w-xl">
          ...
          <div className="flex gap-4 mb-12">
            <button
              ...
              className="bg-red-500 text-white px-6 py-3 font-bold hover:bg-red-600 transition-colors">
              Explorar recetas ↗
            </button>
            <button
              onClick={() => navigate('/info-api')}
              className="border border-white text-white px-6 py-3 font-bold hover:bg-white hover:text-black transition-colors">
              Info de la API
            </button>
          </div>
      ...
      {/* COCINAS DEL MUNDO */}
      <section className="px-4 md:px-16 py-16 bg-[#FAF7F2]">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={() => navigate('/listado')} className="text-sm font-bold hover:underline">Ver todas &gt;</button>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-6 gap-0">
          <div onClick={() => navigate('/listado')} className="bg-red-500 p-6 text-white cursor-pointer hover:opacity-90 transition-opacity">
            <p className="text-2xl mb-2">🍜</p>
            <p className="font-bold">Asia</p>
            <p className="text-xs opacity-80">3241 recetas</p>
          </div>
          <div onClick={() => navigate('/listado')} className="bg-yellow-400 p-6 text-black cursor-pointer hover:opacity-90 transition-opacity">
            <p className="text-2xl mb-2">🥐</p>
            <p className="font-bold">Europa</p>
            <p className="text-xs opacity-80">2167 recetas</p>
          </div>
          <div onClick={() => navigate('/listado')} className="bg-teal-500 p-6 text-white cursor-pointer hover:opacity-90 transition-opacity">
            <p className="text-2xl mb-2">🌮</p>
            <p className="font-bold">América</p>
            <p className="text-xs opacity-80">1893 recetas</p>
          </div>
          <div onClick={() => navigate('/listado')} className="bg-orange-400 p-6 text-white cursor-pointer hover:opacity-90 transition-opacity">
            <p className="text-2xl mb-2">🌍</p>
            <p className="font-bold">África</p>
            <p className="text-xs opacity-80">876 recetas</p>
          </div>
          <div onClick={() => navigate('/listado')} className="bg-black p-6 text-white cursor-pointer hover:opacity-90 transition-opacity">
            <p className="text-2xl mb-2">🫒</p>
            <p className="font-bold">Medio Oriente</p>
            <p className="text-xs opacity-80">654 recetas</p>
          </div>
          <div onClick={() => navigate('/listado')} className="bg-teal-100 p-6 text-black cursor-pointer hover:opacity-90 transition-opacity">
            <p className="text-2xl mb-2">🦞</p>
      ...
      <section className="px-4 md:px-16 py-16 bg-[#FAF7F2]">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={() => navigate('/listado')} className="text-sm font-bold hover:underline">Ver todos &gt;</button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} onClick={() => navigate('/listado')} className="cursor-pointer group">
      ...
      {/* BANNER CTA */}
      <section className="bg-black text-white px-4 md:px-16 py-20 flex flex-col md:flex-row justify-between items-center gap-8">
        <div>
        ...
        <div className="flex flex-col gap-4">
          <button
            onClick={() => navigate('/listado')}
            className="bg-red-500 text-white px-8 py-4 font-bold hover:bg-red-600 transition-colors">
            Comenzar a contribuir →
          </button>
          <button
            onClick={() => navigate('/info-api')}
            className="border border-white text-white px-8 py-4 font-bold hover:bg-white hover:text-black transition-colors">
            Explorar la API
          </button>
        </div>
      </section>
      ...
      <footer className="bg-[#FAF7F2] border-t border-gray-200 px-4 md:px-16 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 text-sm">
          ...
          <button onClick={() => navigate('/listado')} className="hover:underline">Recetas</button>
          <button onClick={() => navigate('/info-api')} className="hover:underline">API</button>
          <button onClick={() => navigate('/dev-team')} className="hover:underline">Equipo</button>
          <button onClick={() => navigate('/filtrado')} className="hover:underline">Filtrado</button>
        </div>
      </footer>
    </main>
  )
